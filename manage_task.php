...
<input type="date" class="form-control form-control-sm" name="due_date" value="<?php echo isset($due_date) ? $due_date : ''; ?>" id="due_date" required>
</div>


<div class="form-group">
	<label for="user_ids">user_ids</label>
	<input type="text" class="form-control form-control-sm" name="user_ids" value="<?php echo isset($user_ids) ? $user_ids : '' ?>" id="user_ids" required>
</div>
