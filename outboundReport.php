      ...
      <div class="content-body">
         ...
         <div class="card">
            <div class="card-header p-1 bg-primary">
               <h4 class="card-title text-white">Outbound Call Report</h4>
                  ...
                  <div class="col-md-3">
                     <div class="form-group">
                        ...
                        if (mysqli_num_rows($res) > 0) {
                           while ($row = mysqli_fetch_assoc($res)) {
                              $selected = '';
                              if (in_array($row['username'], $_POST['users'])) {
                                 $selected = 'selected';
                              }
                  ...
                  <div class="col-md-3">
                     <div class="form-group">
                        ...
                        if (mysqli_num_rows($res) > 0) {
                           while ($row = mysqli_fetch_assoc($res)) {
                              $selected = '';
                              if (in_array($row['extension_no'], $_POST['users'])) {
                                 $selected = 'selected';
                              }
                              echo '<option value="' . $row['extension_no'] . '" ' . $selected . '>' . $row['extension_no'] . '</option>';
                           }
                        } else {
                           echo '<option value="">No record found</option>';
                        }
